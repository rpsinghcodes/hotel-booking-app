...
import { SignedIn, UserButton, useClerk, useUser } from "@clerk/clerk-react";
		...
		>
			...
			<Link to='/' className='flex items-center gap-2'>
				<img
					src={assets.logo}
					alt='logo'
					className={`h-9 ${isScrolled || !isHome ? "invert opacity-80" : ""}`}
				/>
			</Link>
			...
			<div className='hidden md:flex items-center gap-4'>
				{user ? (
					...
					<>
						<img
							src={!user ? assets.searchIcon : assets.userIcon}
							alt='search'
							className={`${
								isScrolled && "invert"
